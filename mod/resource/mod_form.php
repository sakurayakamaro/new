...
class mod_resource_mod_form extends moodleform_mod {
    function definition() {
		...
		/*
		* Adaptive Moodle fields.
		* MKA2015 09082015
		*/
        $mform->addElement('header', 'adaptive', get_string('adaptive'));
        $mform->setExpanded('adaptive');
		$mform->addHelpButton('adaptive', 'adaptiveindicator', '');
		
		$radioarray=array();
		$radioarray[] =& $mform->addElement('advcheckbox', 'knvisual', get_string('learningstyle'), get_string('visual'), array('group' => 1));
		$radioarray[] =& $mform->addElement('advcheckbox', 'knverbal', '', get_string('verbal'), array('group' => 1));	
		$mform->setDefault('knvisual', true);
		$mform->setDefault('knverbal', true);
		
		$radioarray2=array();
		$radioarray2[] =& $mform->addElement('advcheckbox', 'klbeginner', get_string('knowledgelevel'), get_string('beginner'), array('group' => 2));
		$radioarray2[] =& $mform->addElement('advcheckbox', 'klintermediate','', get_string('intermediate'), array('group' => 2));
		$radioarray2[] =& $mform->addElement('advcheckbox', 'kladvance','', get_string('advance'), array('group' => 2));
		$mform->setDefault('klbeginner', true);
		$mform->setDefault('klintermediate', true);
		$mform->setDefault('kladvance', true);
