            ...
            if ($course->id > 0) {
				...
				$sql = 'SELECT distinct u.username, u.firstname, u.lastname
						...
						WHERE 
							...
							c.id = :id';
				$teachers = $DB->get_records_sql($sql, array('id'=>$course->id));
				...
				$html .= "<div style='padding-left:20px; margin-top:0px;'> ";
				
				foreach($teachers as $key => $teacher){
					$html .= "Teacher : ".$teacher->firstname."<br/>";
				}
				$html .= "</div>";
