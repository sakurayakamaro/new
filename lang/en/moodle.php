...
/* 
* Added by MKA(2015)
* Smart Navigation Adaptive E-Learning
* UTM 2015
*/
$string['SNAIL'] = 'Smart Adaptive Learning System - utmsmartlearn';
$string['adaptive'] = 'Adaptive';
$string['ilsquestionnaire'] = 'ILS Questionnaire';
$string['learningstyle'] = 'Learning Style';
$string['knowledgelevel'] = 'Knowledge Level';
$string['cgpa'] = 'CGPA';
...
$string['adaptiveindicator'] = 'Adaptive Indicator';
$string['adaptiveindicator_help'] = 'Learning Style: <span style="color:#594CD8"> Visual</span> | <span style="color:#732C7B">Verbal</span><br> Knowledge Level: <span style="color:#FF6600">Beginner</span> | <span style="color:#FFBF40">Intermediate</span> | <span style="color:#009933">Advance</span>';


$string['infologin'] = 'Login instruction';
$string['adaptivelearning'] = 'Adaptive Learning';
$string['infographic'] = 'Infographic';
$string['faq'] = 'FAQ';
$string['help'] = 'Help';
