...
/**
 * Strings for component 'bim', language 'ar', version '2.9'.
 *
 * @package     bim
 * @category    string
...
$string['progressResult_help'] = 'يظهر إجمالي العلامات الممنوحة إلى إجاباتك المطلقة. النتائج الخاصة بالإجابات المؤشرة غير مضمنة هنا، إذا ينبغي مراجعتها أولاً.';
