...
/**
 * Strings for component 'block_course_contacts', language 'ar', version '2.9'.
 *
...
$string['course_contacts'] = 'جهات إنصال مقرر دراسي';
$string['online'] = 'متصل بالإنترنت';
$string['pluginname'] = 'جهات إتصال مقرر دراسي';
