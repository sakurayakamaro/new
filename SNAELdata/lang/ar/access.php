...
/**
 * Strings for component 'access', language 'ar', version '2.9'.
 *
 * @package     access
 * @category    string
...
$string['hideblocka'] = 'إخفاء مربع {$a}';
$string['monthnext'] = 'الشهر الموالي';
$string['monthprev'] = 'الشهر السابق';
$string['showblocka'] = 'إظهار مربع {$a}';
$string['sitemap'] = 'خارطة الموقع';
$string['skipa'] = 'تجاوز';
$string['skipblock'] = 'تجاوز مربع';
