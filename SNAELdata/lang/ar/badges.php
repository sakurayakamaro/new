...
/**
 * Strings for component 'badges', language 'ar', version '2.9'.
 *
 * @package     badges
 * @category    string
...
$string['addbadgecriteria'] = 'إضافة معايير شارة';
$string['addcourse'] = 'إضافة مواد';
$string['addcourse_help'] = 'حدد جميع المواد التي ينبغي إضافتها إلى متطلبات الشارة. اضغط المفتاح CTRL لتحديد عناصر متعددة.';
...
$string['allmethodcourseset'] = 'جميع المواد المحددة كاملة';
$string['allmethodmanual'] = 'جميع الأدوار المحددة تمنح الشارة';
$string['allmethodprofile'] = 'تم إكمال جميع حقول ملف التعريف المحدد';
$string['allowcoursebadges'] = 'تمكين شارات المواد';
$string['allowcoursebadges_desc'] = 'السماح بإنشاء الشارات و منحها في سياق المادة';
...
$string['anymethodcourseset'] = 'أي من المواد المحددة كاملة';
...
$string['attachment'] = 'تعلق الشارة على الرسالة';
...
$string['backpackavailability_help'] = 'لكي يتمكن المستلمون من الشارة من إثبات حصولهم على شاراتهم منك ، يجب أن تكون خدمة ظهر بظهر الخارجية قادرة على الوصول إلى موقعك والتحقق من الشارات الصادرة منه. لا يبدو أن موقعك متاح حاليًا ، مما يعني أنه لا يمكن التحقق من الشارات التي أصدرتها بالفعل أو التي ستصدرها في المستقبل.
** لماذا أرى هذه الرسالة؟
** قد يكون أن جدار الحماية الخاص بك يمنع الوصول من المستخدمين خارج شبكتك ، أو أن موقعك محمي بكلمة مرور ، أو تقوم بتشغيل الموقع على جهاز كمبيوتر غير متاح من الإنترنت (مثل آلة التنمية المحلية).
** هل هذه مشكلة؟
** يجب إصلاح هذه المشكلة على أي موقع إنتاج تخطط لإصدار شارات فيه ، وإلا فلن يتمكن المستلمون من إثبات أنهم حصلوا على شاراتهم منك. إذا لم يكن موقعك مباشرًا بعد ، فيمكنك إنشاء شارات اختبار وإصدارها ، طالما أن الموقع يمكن الوصول إليه قبل الدخول مباشرة.
** ماذا لو لم أتمكن من جعل موقعي بالكامل متاحًا للجميع؟
** عنوان URL الوحيد المطلوب للتحقق هو [your-site-url] /badges/assertion.php ، إذا كنت قادرًا على تعديل جدار الحماية الخاص بك للسماح بالوصول الخارجي إلى هذا الملف ، سيظل التحقق من الشارة يعمل.';
$string['backpackbadges'] = 'لديك
{$a-> total badges} badges)
التي يتم عرضها من
{{$a> total collectionions} Collections).
تغيير إعدادات ظهر بظهر.';
$string['backpackconnection'] = 'الاتصال ظهر بظهر';
...
$string['backpackdetails'] = 'إعدادات ظهر بظهر';
$string['backpackemail'] = 'عنوان البريد الإلكتروني';
$string['backpackemail_help'] = 'عنوان البريد الإلكتروني المرتبط ظهر بظهر. أثناء الاتصال ، سيتم ربط أيّ شارات تم الحصول عليها على هذا الموقع بعنوان البريد الإلكتروني هذا.';
...
$string['badgeprivacysetting_str'] = 'عرض الشارات تلقائيًا التي أكسبها على صفحة ملفي الشخصي';
$string['badges'] = 'الشارات';
$string['badgesalt'] = 'ملح لتجزئة عنوان البريد الإلكتروني للمستلم';
$string['badgesalt_desc'] = 'يتيح استخدام التجزئة لخدمات الظهر بالظهر على تأكيد حامل شارة دون الحاجة إلى كشف عنوان البريد الإلكتروني. يجب أن يستخدم هذا الإعداد فقط الأرقام و الحروف. ملاحظة: لأغراض التحقق من المستلم ، يرجى تجنب تغيير هذا الإعداد بمجرد بدء إصدار الشارات.';
...
$string['badgesview'] = 'شارات المادة';
...
$string['completionnotenabled'] = 'لم يتم تمكين إتمام المادة لهذا المقرر ، لذلك لا يمكن تضمينها في معايير الشارة. قد يتم تمكين إكمال المادة التدريبية في إعدادات المقرر.';
...
$string['criteria_2'] = 'نسخة يدوية صادرة عن الدور';
$string['criteria_2_help'] = 'للسماح بشارة يتم منحها يدويًا من قبل المستخدمين الذين لديهم دور معين داخل الموقع أو الدورة التدريبية.';
...
$string['criteria_5'] = 'استكمال مجموعة من المواد';
$string['criteria_5_help'] = 'يسمح بإعطاء شارة للمستخدمين الذين أكملوا مجموعة من المواد. يمكن أن تحتوي كل مادة على معايير إضافية مثل الحد الأدنى للصف و تاريخ إكمال المادة.';
...
$string['criteria_descr_single_short2'] = 'منحت من قبل:';
...
$string['deletehelp'] = 'إن حذف الشارة بالكامل يعني أن جميع سجلات المعلومات و المعايير الخاصة بها ستتم إزالتها نهائيًا. لن يتمكن المستخدمون الذين حصلوا على هذه الشارة من الوصول إليها و عرضها على صفحات ملفاتهم الشخصية.

ملاحظة: المستخدمون الذين حصلوا على هذه الشارة و دفعوها بالفعل إلى ظهر بظهر الخارجية الخاصة بهم ، سيظلون يحملون هذه الشارة في ظهر بظهر الخارجية الخاصة بهم. ومع ذلك ، لن يتمكنوا من الوصول إلى المعايير و صفحات الأدلة المرتبطة مرة أخرى بهذا الموقع.';
...
$string['error:backpackdatainvalid'] = 'إرجاع البيانات من ظهر بظهر غير صالح.';
$string['error:backpackemailnotfound'] = 'البريد الإلكتروني \'{$a}\' غير مرتبط ظهر بظهر. تحتاج إلى إنشاء ظهر بظهر لهذا الحساب أو تسجيل الدخول باستخدام عنوان بريد إلكتروني آخر.';
$string['error:backpackloginfailed'] = 'لا يمكن أن تكون متصلاً ظهر بظهر الخارجية للسبب التالي: {$a}';
$string['error:backpacknotavailable'] = 'لا يمكن الوصول إلى موقعك عبر الإنترنت ، لذلك لا يمكن التحقق من أي شارات صادرة من هذا الموقع بواسطة خدمات ظهر بظهر الخارجية.';
$string['error:backpackproblem'] = 'حدثت مشكلة أثناء الاتصال بموفر خدمة ظهر بظهر. الرجاء معاودة المحاولة في وقت لاحق.';
$string['error:badjson'] = 'شارة غير موجودة';
...
$string['error:noassertion'] = 'لم يرد أي تأكيد من قبل الشخص.. ربما تكون قد أغلقت مربع الحوار قبل إكمال عملية تسجيل الدخول.';
...
$string['error:personaneedsjs'] = 'حاليا ، جافا سكريبت مطلوب للاتصال بك ظهر بظهر. إذا كنت تستطيع ، فقم بتمكين Javascript وأعد تحميل الصفحة.';
...
$string['existingrecipients'] = 'مستلمو الشارة حاليين';
...
$string['externalbadges_help'] = 'تعرض هذه المنطقة شارات من ظهر بظهر الخارجية.';
$string['externalbadgesp'] = 'شارات من مواقع الويب الأخرى:';
$string['externalconnectto'] = 'لعرض الشارات الخارجية ، تحتاج إلى الاتصال ظهر بظهر.';
$string['fixed'] = 'تاريخ ثابت';
$string['hidden'] = 'مخفي';
$string['hiddenbadge'] = 'لسوء الحظ ، لم يجعل مالك الشارة هذه المعلومات متاحة.';
$string['issuancedetails'] = 'انتهاء الصلاحية الشارة';
...
$string['localbadgesh_help'] = 'جميع الشارات المكتسبة في هذا الموقع عن طريق استكمال المواد و أنشطة المقررات  و غيرها من المتطلبات. يمكنك إدارة الشارات الخاصة بك هنا بجعلها عامة أو خاصة لصفحة ملفك الشخصي. يمكنك تنزيل جميع الشارات الخاصة بك أو كل شارة على حدة وحفظها على جهاز الكمبيوتر الخاص بك. يمكن إضافة الشارات التي تم تنزيلها إلى خدمة ظهر بظهر الخارجية.';
$string['localbadgesp'] = 'شارات من {$a}:';
$string['localconnectto'] = 'لمشاركة هذه الشارات خارج موقع الويب هذا ، تحتاج إلى الاتصال ظهر بظهر.';
...
$string['method'] = 'اكتمل هذا المعيار عندما ...';
$string['mingrade'] = 'الحد الأدنى للصف المطلوب';
$string['month'] = '(الشهور)';
$string['mybackpack'] = 'إعداداتي ظهر بظهر';
$string['mybadges'] = 'شاراتي';
$string['never'] = 'أبداً';
$string['newbadge'] = 'أضف شارة جديدة';
$string['newimage'] = 'صورة جديدة';
$string['noawards'] = 'لم يتم الحصول على هذه الشارة بعد.';
$string['nobackpack'] = 'لا توجد خدمة ظهر بظهر متصلة بهذا الحساب.';
...
إضافة مجموعات.';
$string['nobadges'] = 'لا توجد شارات المتاحة.';
...
$string['notification'] = 'إخطار منشئ شارة';
...
** أبداً** - لا ترسل إعلامات. *
** في كل مرة ** - إرسال إشعار في كل مرة يتم منح هذه الشارة. *
 ** يومياً ** - إرسال الإخطارات مرة واحدة في اليوم. *
** أسبوعياً ** - إرسال الإخطارات مرة واحدة في الأسبوع. *
** شهرياً** - إرسال الإخطارات مرة واحدة في الشهر.';
...
$string['personaconnection'] = 'تسجيل الدخول مع البريد الإلكتروني الخاص بك';
$string['potentialrecipients'] = 'مستلمو شارة المحتملين';
...
$string['recipients'] = 'مستلمين شارة';
...
$string['reviewconfirm'] = 'سيؤدي ذلك إلى جعل شارتك مرئية للمستخدمين ويسمح لهم بالبدء في كسبها.

من المحتمل أن يكون بعض المستخدمين قد استوفوا بالفعل معايير هذه الشارة وسيصدرون هذه الشارة فور تمكينها.

بمجرد إصدار شارة ، سيتم قفلها - لم يعد بالإمكان تغيير إعدادات معينة بما في ذلك المعايير وإعدادات انتهاء الصلاحية.

هل تريد بالتأكيد تمكين الوصول إلى الشارة \'{$a}\'؟';
$string['save'] = 'حفظ';
...
$string['selectgroup_start'] = 'حدد مجموعات من ظهر بظهر الخاصة بك لعرضها على هذا الموقع:';
$string['selecting'] = 'مع الشارات المحددة ...';
$string['setup'] = 'إعداد الاتصال';
$string['signinwithyouremail'] = 'تسجيل الدخول ببريدك الإلكتروني';
$string['sitebadges'] = 'شارات الموقع';
$string['sitebadges_help'] = 'لا يمكن منح شارات الموقع إلا للمستخدمين للأنشطة المتعلقة بالموقع. و تشمل هذه استكمال مجموعة من المواد أو أجزاء من ملفات تعريف المستخدمين. يمكن أيضًا إصدار شارات الموقع يدويًا من قبل مستخدم لآخر. يجب إنشاء شارات للأنشطة المتعلقة بالمادة على مستوى المادة. يمكن العثور على شارات المقرر ضمن إدارة المادة> الشارات.';
$string['status'] = 'حالة الشارة';
$string['status_help'] = 'تحدد حالة الشارة سلوكها في النظام: *
** متاح** - يعني أنه يمكن للمستخدمين الحصول على هذه الشارة. في حين أن شارة متاحة للمستخدمين ، لا يمكن تعديل معاييرها. *
** غير متوفر ** - تعني أن هذه الشارة غير متاحة للمستخدمين و لا يمكن الحصول عليها أو إصدارها يدويًا. إذا لم تصدر هذه الشارة من قبل ، فيمكن تغيير معاييرها. بمجرد إصدار شارة لمستخدم واحد على الأقل ، تصبح تلقائيًا ** مقفلة**. لا يزال بإمكان المستخدمين الحصول على شارات مقفلة ، و لكن لم يعد من الممكن تغيير معاييرهم. إذا كنت بحاجة إلى تعديل تفاصيل أو معايير شارة مقفلة ، فيمكنك تكرار هذه الشارة وإجراء جميع التغييرات المطلوبة.
* لماذا نقوم بتأمين الشارات؟ * نريد التأكد من أن جميع المستخدمين يكملون نفس المتطلبات لكسب شارة. حاليًا ، لا يمكن إلغاء الشارات. إذا سمحنا بتعديل متطلبات الشارات في كل وقت ، فمن المرجح أن ينتهي الأمر بنا إلى حصول المستخدمين على نفس الشارة لتلبية متطلبات مختلفة تمامًا.';
