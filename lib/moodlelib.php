 ...
 * UTM 2015
 * Security key for encryption and decryption
 */
define('SEC_KEY', '$N@1L#MK@2O|S$3(U73');
 ...
 */
function adaptive_encrypt($string){
	$result = "";
	for($i=0; $i<strlen($string); $i++) {
		$char = substr($string, $i, 1);
		$keychar = substr(SEC_KEY, ($i % strlen(SEC_KEY))-1, 1);
...
function adaptive_decrypt($string){
	$result = "";
