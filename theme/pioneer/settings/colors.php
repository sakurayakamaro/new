...
$temp = new admin_settingpage('theme_pioneer_colorheading', get_string('colorheading', 'theme_pioneer'));
    ...
    // @Marketing Box text background color setting.
    ...
    // @Marketing Box background color setting.
    $name = 'theme_pioneer/marketboxbuttoncolor';
    $title = get_string('marketboxbuttoncolor', 'theme_pioneer');
    $description = get_string('marketboxbuttoncolor_desc', 'theme_pioneer');
    $default = '#FFFFFF';
    $setting = new admin_setting_configcolourpicker($name, $title, $description, $default, null, false);
    $setting->set_updatedcallback('theme_reset_all_caches');
    $temp->add($setting);
